...
# БАГ ПОФИКСИЛ!: БАГ!!! ПРИОРИТЕТ - на http://localhost:8000/main могу зайти в main.html по любому юзеру и админу - но зайти на http://192.168.0.199:8000 на леново не получается - баг - пароли и логины корректные FastAPI сохраняет сессию! тк в куки на леново http://192.168.0.199:8000 а на маке http://localhost:8000/main
